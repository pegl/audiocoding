...
fetchSample('AirportTerminal.wav').then(convolverBuffer => {
  ...
  */
  startLoop('Grand Piano', 'F4',  convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'Ab4', convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'C5',  convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'Db5', convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'Eb5', convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'F5',  convolver, getRandomLength(), getRandomDelay());
  startLoop('Grand Piano', 'Ab5', convolver, getRandomLength(), getRandomDelay());
});
